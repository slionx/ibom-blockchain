...
import { makeRegistryProgram, parseBytes32, parseCreators, creatorsShareSumOk, workPda, makeServerWallet, systemProgramPk } from "@/lib/solana/server";
...
export async function POST(req: NextRequest) {
  try {
    ...
    const txSig = await program.methods
      .registerWork(workId as any, metadataUri, fingerprintHash as any, creators as any)
      .accounts({ authority, work: pda, systemProgram: systemProgramPk() })
      .rpc();
